...
import com.example.chat_app.views.ChatFromItem
import com.example.chat_app.views.ChatToItem
...
//    val reference = FirebaseDatabase.getInstance().getReference("/messages").push()
        ...
        val latestMessagesToRef = FirebaseDatabase.getInstance().getReference("/latest-messages/$fromId/$toId")
